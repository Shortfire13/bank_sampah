                ...
                <div class="col-md-12">
                    <div class="panel">
                        ...
                        <div class="panel-body">
                            <form action="/dash/pegawai/update/{{$pegawai->id_pegawai}}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="form-group row">
                                    <label for="nama_pegawai" class="col-sm-2 col-form-label">Nama Pegawai</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="nama_pegawai"
                                        placeholder="Masukkan Nama Anda" value="{{$pegawai->nama_pegawai}}">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        placeholder="Masukkan Alamat Anda" value="{{$pegawai->alamat}}">
                                        <div class="text-danger">
                                            @error('alamat')
                                                {{ $message }}
                                            @enderror   
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        placeholder="Masukkan Usia Anda" value="{{$pegawai->umur}}">
                                        <div class="text-danger">
                                            @error('umur')
                                                {{ $message }}
                                            @enderror   
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        placeholder="Masukkan Nomor Telepon Anda" value="{{$pegawai->no_telp}}">
                                        <div class="text-danger">
                                            @error('no_telp')
                                                {{ $message }}
                                            @enderror   
